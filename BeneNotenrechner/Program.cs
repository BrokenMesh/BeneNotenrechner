        ...
        public static void Main(string[] args) {
            ...
            foreach (SuperSubject superSubject in _superSubjects) {
                ...
                foreach (Subject _subject in _subjects) {
                    db.CreateGrade(_subject, 5.5f, DateTime.Now);
                    db.CreateGrade(_subject, 5.0f, DateTime.Now);
                    db.CreateGrade(_subject, 4.5f, DateTime.Now);
                    db.CreateGrade(_subject, 3.5f, DateTime.Now);
                    db.CreateGrade(_subject, 1.0f, DateTime.Now);
                }
